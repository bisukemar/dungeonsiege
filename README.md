...
- Refined obstacle behavior for smoother gameplay
- Adjusted boss round mechanics
- Updated kill count requirements per round
- Added new player sprite
- Added grass background environment
- Added stats information display
- - Hover over a stat (desktop)
- - Tap a stat name (mobile)
