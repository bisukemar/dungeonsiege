export const SKILL_DB = {
  ...
  Bash: {
    ...
    perLevel:2,
    cooldown:70,
    desc:'Single-target bash at the nearest foe. Scales with STR.',
    unlockLevel:1,
  ...
  PiercingStrike: {
    ...
    element:'NEUTRAL',
    tier:'II',
    icon:'assets/skill/Pierce.gif',
    maxLevel:7,
    perLevel:2,
    cooldown:90,
    desc:'Narrow forward melee arc that pierces all enemies once. Scales with STR.',
    unlockLevel:5,
    baseDamage:(s,l)=>Math.max(1,Math.floor(s.str*2.2 + l*1.5))
  },
  Magnum: {
    key:'Magnum',
    name:'Magnum Break',
  ...
  ArrowStorm: {
    ...
    element:'NEUTRAL',
    tier:'III',
    icon:'assets/skill/ArrowStorm.gif',
    maxLevel:7,
    perLevel:2,
    cooldown:260,
    desc:'Rain arrows in a circular area. Multiple impacts at higher levels.',
    unlockLevel:7,
    prereqSkills: { ArrowShower: 3 }
  },
